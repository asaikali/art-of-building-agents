...
/**
 * Restaurant tools — same as Step 03. Search, expense policy, dietary checks, and booking.
 *
 * <p>Identical tools, but in this step they're wrapped with hooks that intercept every call.
 */
@Service
