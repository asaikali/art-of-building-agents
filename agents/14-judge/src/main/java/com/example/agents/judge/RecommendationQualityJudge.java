...
/**
 * T2 LLM judge: evaluates recommendation quality. Only fires if T0 and T1 deterministic judges pass
 * (CascadedJury escalation). Uses an LLM to assess whether the recommendation is well-reasoned and
 * helpful.
 */
public class RecommendationQualityJudge extends LLMJudge {
  ...
  protected String buildPrompt(JudgmentContext context) {
    return String.format(
        ...
        Rate this recommendation on these criteria:
        1. Does it clearly name a specific restaurant?
        2. Does it explain WHY this restaurant fits the requirements?
