...
- Steps 01-04 implemented, compiling on Spring AI 2.0.0-M3 + Spring Boot 4.1.0-M2 + AgentWorks BOM 1.0.3
...
- Parent POM imports agentworks-bom 1.0.3 for version management (workflow-core 0.2.0, MiniAgent→AgentLoop rename)
...
| 04 | AgentLoopAdvisor | `io.github.markpollack:workflow-core` | 0.2.0 (via BOM 1.0.3) |
| 05 | AgentLoop + Journal | `workflow-agents` + `journal-core` | 0.2.0 / 0.9.0 |
